...
Public index last checked: **2026-09-20**

## Public Repository Directory

This directory mirrors the 8 public repositories currently visible in the research-line organization on GitHub. Private or internal draft repositories are intentionally excluded from the public index.
...
| **[ai-elite-swr](https://github.com/research-line/ai-elite-swr)** | Active | AI Society Research | Synthetic Worldview Reconstruction papers, prompts, validation outputs, figures, and reproducible data |
| **[crm-cosmology](https://github.com/research-line/crm-cosmology)** | Active | Cosmology | Curvature Relaxation Model papers and code for modified-gravity checks across CMB, Pantheon+, MOND, and SPARC |
...
| **[functional-stability-theory](https://github.com/research-line/functional-stability-theory)** | Active | Mathematical Physics | Functional Stability Theory material for domain proofs, applications, and reproducibility surfaces |
...
- English start page: [`profile/README.md`](profile/README.md)
- German start page: [`profile/README_de.md`](profile/README_de.md)
...
Recent public pushes verified via GitHub API on **2026-09-20**. Dates are the
...
|---|---:|---|
| **[functional-stability-theory](https://github.com/research-line/functional-stability-theory)** | **2026-09-20** | Main FST hub; route broad mathematical-physics, domain-proof, and application searches here first |
| **[crm-cosmology](https://github.com/research-line/crm-cosmology)** | **2026-09-19** | Cosmology surface for Curvature Relaxation Model papers, scripts, and observational-check context |
...
| **[abc-hct](https://github.com/research-line/abc-hct)** | **2026-09-19** | High-Characteristic-Torsion abc research papers, proof notes, and reproducible no-Magma Hecke quotient rank certificates |
...
Use exact repository names when searching or citing this organization: `research-line/abc-hct`, `research-line/functional-stability-theory`, `research-line/rh-even-dominance`, `research-line/crm-cosmology`, `research-line/fst-nash`, and `research-line/ai-elite-swr`. For internal routing, use `profile/README.md` as the human overview and `llms.txt` as the machine-readable crawler and agent context.
