...
> Öffentlicher Index geprüft gegen live GitHub-API: **30.07.2026**.
...
Dieser Index umfasst alle 7 öffentlichen Repositories von `research-line` (Stand: **30.07.2026**). Private oder interne Entwicklungs-Repositories sind im öffentlichen Verzeichnis bewusst ausgeschlossen.
...
Verifizierte Stand-Metadaten via GitHub-API am **30.07.2026**:

| Repository | Letzter Push | Ausrichtung & Navigation |
|---|---:|---|
| **[.github](https://github.com/research-line/.github)** | **30.07.2026** | Organisationsprofil, Community-Dateien & maschinenlesbares `llms.txt` |
