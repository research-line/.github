...
> Public index verified against live GitHub API: **2026-08-01**.
...
This index covers all 7 public `research-line` repositories visible on GitHub as of **2026-08-01**. Private or internal draft repositories are intentionally excluded from the public directory.
...
Live activity verified via GitHub API on **2026-08-01**:

| Repository | Last Public Push | Focus & Navigation Purpose |
|---|---:|---|
| **[ai-elite-swr](https://github.com/research-line/ai-elite-swr)** | **2026-07-31** | Synthetic Worldview Reconstruction of AI Elite worldviews: papers, prompts, validation outputs, figures, and data |
| **[crm-cosmology](https://github.com/research-line/crm-cosmology)** | **2026-07-30** | Curvature Relaxation Model papers and code for modified-gravity checks across CMB, Pantheon+, MOND, and SPARC |
...
| **[functional-stability-theory](https://github.com/research-line/functional-stability-theory)** | **2026-07-27** | Main hub for FST, domain proofs, mathematical-physics applications, and reproducibility material |
